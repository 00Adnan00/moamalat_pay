...
class MoamalatTransactionFailed {
  ...
  /// Creates a new [MoamalatTransactionFailed] instance.
  ///
  ...
  const MoamalatTransactionFailed({
    this.error,
    this.amount,
  ...
  /// Creates a [MoamalatTransactionFailed] instance from a JSON map.
  ///
  ...
  /// ```
  factory MoamalatTransactionFailed.fromJson(Map<String, dynamic> json) {
    return MoamalatTransactionFailed(
      error: json['error'],
      amount: json['Amount'],
  ...
  /// Converts this [MoamalatTransactionFailed] instance to a JSON map.
  ///
  ...
  /// Returns a string representation of this [MoamalatTransactionFailed].
  ///
