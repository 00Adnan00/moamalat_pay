...
class MoamalatPayment extends StatefulWidget {
  ...
  /// Merchant's secret key for transaction signing (computed locally).
  ///
  ...
  /// Provide either this or [secureHash].
  final String? merchantSecretKey;

  /// The pre-computed secure hash generated by your backend.
  ///
  /// **Recommended for production** to avoid storing the secret key in the app.
  /// Provide either this or [merchantSecretKey].
  final String? secureHash;

  /// The exact transaction date string used by your backend to generate the [secureHash].
  ///
  /// If provided, this string is used as the timestamp instead of the [timeStamp] object.
  ...
  MoamalatPayment({
    ...
    DateTime? timeStamp,
         ...
         merchantSecretKey != null || secureHash != null,
         'Either merchantSecretKey or secureHash must be provided',
       ),
...
class _MoamalatPaymentState extends State<MoamalatPayment> {
  ...
  String get _timeStamp =>
      widget.transactionDate ?? (widget.timeStamp.millisecondsSinceEpoch ~/ 1000).toString();
  ...
  String _hash() {
    if (widget.secureHash != null) return widget.secureHash!;
